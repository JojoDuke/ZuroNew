...
const AtvInsurance = () => {
    return(
        <>
            {/* model & make */}
            <input type="text" placeholder='ATV Make &amp; Model' className='w-[80%] px-5 bg-[#181818] h-[60px] rounded-xl my-5 outline-none'/>

            {/* year */}
            <input type="text" placeholder='Which year is this ATV' className='w-[80%] px-5 bg-[#181818] h-[60px] rounded-xl my-5 outline-none'/>

            {/* mileage */}
            <input type="text" placeholder='ATV Mileage' className='w-[80%] px-5 bg-[#181818] h-[60px] rounded-xl my-5 outline-none'/>
