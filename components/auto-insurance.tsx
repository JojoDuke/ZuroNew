...
const AutoInsurance = () => {
    return(
        <>
            {/* input vehicle make */}
            <input type="text" placeholder='Vehicle Make &amp; Model' className='w-[80%] px-5 bg-[#181818] h-[60px] rounded-xl my-5 outline-none'/>


            {/* input year of vehicle */}
            <input type="text" placeholder='Which year is this vehicle' className='w-[80%] px-5 bg-[#181818] h-[60px] rounded-xl my-5 outline-none'/>

            {/* vehicle mileage */}
            <input type="text" placeholder='Vehicle Mileage' className='w-[80%] px-5 bg-[#181818] h-[60px] rounded-xl my-5 outline-none'/>
