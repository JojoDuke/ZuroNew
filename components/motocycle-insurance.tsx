...
const MotocycleInsurance = () => {
    return(
        <>
            {/* input motocycle make */}
            <input type="text" placeholder='Motocycle Make &amp; Model' className='w-[80%] px-5 bg-[#181818] h-[60px] rounded-xl my-5 outline-none'/>


            {/* input year of motocycle */}
            <input type="text" placeholder='Which year is this Motocycle' className='w-[80%] px-5 bg-[#181818] h-[60px] rounded-xl my-5 outline-none'/>

            {/* motocycle mileage */}
            <input type="text" placeholder='Motocycle Mileage' className='w-[80%] px-5 bg-[#181818] h-[60px] rounded-xl my-5 outline-none'/>
...
export default MotocycleInsurance